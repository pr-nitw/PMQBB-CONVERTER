...
plot(d, g28, '-s',  'Color', [0.30 0.75 0.93], 'LineWidth', 2);          
plot(d, g29, '-*',  'Color', [1.00 0.27 0.00], 'LineWidth', 2);          
plot(d, g30, '-.d', 'Color', [0.30 0.30 0.30], 'LineWidth', 2);          
plot(d, g31, ':<',  'Color', [0.00 0.50 0.00], 'LineWidth', 2);          
plot(d, gp,  '-->', 'Color', [0.00 0.00 0.60], 'LineWidth', 2);         
